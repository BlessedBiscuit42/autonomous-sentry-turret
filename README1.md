...
* **Raspberry Pi Zero 2 W $\rightarrow$ Arduino Mega 2560 (UART Serial Interface):**
  * Pi **TX (GPIO 14)** $\rightarrow$ Mega **RX1 (Pin 19)**
  * Pi **RX (GPIO 15)** $\rightarrow$ Mega **TX1 (Pin 18)**
  * Pi **GND** $\rightarrow$ Mega **GND** (Common Ground Reference)
* **Arduino Mega 2560 $\rightarrow$ Actuators & Circuitry:**
  * **Pin D9:** Pan Servo PWM Signal
  * **Pin D10:** Tilt Servo PWM Signal
  * **Pin D8:** Transistor Base (via 1kΩ resistor) $\rightarrow$ Laser Module Power
